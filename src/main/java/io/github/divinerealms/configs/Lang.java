...
public enum Lang {
  ...
  HELP("help", String.join(System.getProperty("line.separator"),
      ...
      "&6 /&elm ban &2<&aplayer-name&2> <&aduration&2> <&areason&2>",
  ...
  USER_USAGE_BAN("user.usage.ban", String.join(System.getProperty("line.separator"),
      "&4▎ &cInvalid arguments. Usage:",
      "&4▎ &6/&elm ban &2<&aplayer-name&2> &3[&bduration&3] &3[&breason&3]")),
  ...
  USER_HELP("user.help", String.join(System.getProperty("line.separator"),
      ...
      "&7   - &fUnban player from FC.",
      "&7▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬&r")),
  VAR_GIVEN_ACCESS("var.given-access", "&a▎ &fSuccessfully &agiven &faccess to VAR for &b{0}&f."),
  VAR_REMOVED_ACCESS("var.removed-access", "&a▎ &fSuccessfully &cremoved &faccess to VAR for &b{0}&f."),
