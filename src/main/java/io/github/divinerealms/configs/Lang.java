...
public enum Lang {
  ...
  RESULT_HELP("result.help", String.join(System.lineSeparator(),
      ...
      "&r &r",
      "&6 /&eresult create &2<&atime&2> <&aprefix&2> <&ateamOne&2> <&ateamTwo&2>",
      "&7   - &fExample: &6/&eresult create 10min &e&lServerliga&r &0N&fK&0P &2V&4T&2Z",
      "&6 /&eresult stop &2<&aid&2>",
      "&6 /&eresult add&6/&eremove 1&6/&e2",
      "&7   - &fAdd/Remove one goal to team 1 or 2.",
      "&7▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬&r")),
  RESULT_ADD("result.add", "&a▎ &fAdded one goal for the team {0}&f."),
  RESULT_REMOVE("result.remove", "&a▎ &fRemoved one goal for the team {0}&f."),
  RESULT_USAGE("result.add-usage", "&4▎ &cYou need to specify a team (1 or 2)."),
  RESULT_STARTING("result.starting", "{0} &7┃ &fHost starting!"),
  RESULT_ACTIONBAR("result.actionbar", "{0} &7┃ {1} &e{2} - {3} {4} &7┃ &fTimer: &a{5}/{6}"),
