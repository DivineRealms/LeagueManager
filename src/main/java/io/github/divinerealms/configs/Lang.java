...
public enum Lang {
  ...
  USER_USAGE_SET_MANAGER("user.usage.make-manager", String.join(System.getProperty("line.separator"),
      "&4▎ &cInvalid arguments. Usage:",
      "&4▎ &6/&elm sm&6|&esetmanager &2<&aplayer-name&2> <&ateam-name&2>")),
  USER_USAGE_UNSET_MANAGER("user.usage.make-manager", String.join(System.getProperty("line.separator"),
      "&4▎ &cInvalid arguments. Usage:",
