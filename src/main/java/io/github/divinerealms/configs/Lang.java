...
public enum Lang {
  ...
  ROSTERS_SET_USAGE("rosters.set.usage", String.join(System.lineSeparator(),
      "&b▎ &fPodesite parametre igrača komandom: &6/&ert set &2<&atim&2> <&aigrač&2> <&aparametar&2> <&aunos&2>",
      "&b▎ &fPrimer: &6/&ert set ADM Neeonn position CB",
      "&b▎ &fPrimer: &6/&ert set ADM Neeonn country Srbija")),
  ...
  ROSTERS_SET("rosters.set", "&a▎ &b{0} &fje postavio/la &e{1} &fza tim {2} &fna: &e{3}&f."),
