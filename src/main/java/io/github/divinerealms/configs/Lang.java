...
public enum Lang {
  ...
  TIMER_HELP("timer.help", String.join(System.lineSeparator(),
      ...
      "&r &r",
      "&6 /&etimer create &2<&atime&2> &3[&bprefix&3]",
      "&6 /&etimer stop &2<&aid&2>",
      "&7▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬&r")),
  ...
  RESULT_END("result.end", "{0} &7┃ &fMatch finished! Result: {1} &e{2} &f- &e{3} {4}&f."),
  RESULT_HALFTIME("result.halftime", "&6▎ {0} &6┃ &fHalf Time! Result: {1} &e{2} &f- &e{3} {4}&f."),
  RESULT_SECONDHALF("result.secondhalf", "&6▎ {0} &6┃ &fMatch continuing - Second Half! Result: {1} &e{2} &f- &e{3} {4}&f."),
  RESULT_OVER("result.over", "&6▎ {0} &6┃ &fMatch finished! Result: {1} &e{2} &f- &e{3} {4}&f."),
  TWO_TIMES_FOUR_HELP("result.2x4.help", String.join(System.lineSeparator(),
      ...
      "&6 /&e2x4 tp &7- &fTeleport to 2x4 Warp.",
